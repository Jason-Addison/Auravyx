...
Most up-to-date version: Alpha-1.0.2 Release

How to play: Extract Alpha-1.0.2.zip an run the .exe, if this fails make sure anti-virus are ignoring it (Windows Defender may try to auto-delete)
